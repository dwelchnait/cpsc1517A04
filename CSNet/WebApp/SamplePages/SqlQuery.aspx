...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="offset-2">
        ...
        <asp:GridView ID="ProductList" runat="server" AutoGenerateColumns="False"
            ...
            AllowPaging="True" OnSelectedIndexChanged="ProductList_SelectedIndexChanged"
            PageSize="5" OnPageIndexChanging="ProductList_PageIndexChanging">
            <Columns>
            ...
            <EmptyDataTemplate>
                this is a message to tell the user that there is no data to display
            </EmptyDataTemplate>
